...
#ifndef HL_NAVIGATION_CORE_BEHAVIOR_HL_H_
#define HL_NAVIGATION_CORE_BEHAVIOR_HL_H_
 ...
 */
class HL_NAVIGATION_CORE_EXPORT HLBehavior : public Behavior {
 public:
  /**
   * Default \f$\eta\f$
   */
...
#endif  // HL_NAVIGATION_CORE_BEHAVIOR_HL_H_
