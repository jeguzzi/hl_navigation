...
#ifndef HL_NAVIGATION_CORE_BEHAVIOR_ORCA_H_
#define HL_NAVIGATION_CORE_BEHAVIOR_ORCA_H_
 ...
 */
class HL_NAVIGATION_CORE_EXPORT ORCABehavior : public Behavior {
 public:
  /**
...
#endif  // HL_NAVIGATION_CORE_BEHAVIOR_ORCA_H_
