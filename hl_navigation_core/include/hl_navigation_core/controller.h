...
#ifndef HL_NAVIGATION_CORE_CONTROLLER_H_
#define HL_NAVIGATION_CORE_CONTROLLER_H_
 ...
 */
struct HL_NAVIGATION_CORE_EXPORT Action {
  /**
...
struct HL_NAVIGATION_CORE_EXPORT FollowTwistAction : public Action {
  using Action::Action;
};

struct HL_NAVIGATION_CORE_EXPORT FollowAction : Action {
  using Action::Action;
};

struct HL_NAVIGATION_CORE_EXPORT MoveAction : Action {
  using Action::Action;
 ...
 */
class HL_NAVIGATION_CORE_EXPORT Controller {
 public:
  /**
