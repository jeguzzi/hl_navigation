...
#ifndef HL_NAVIGATION_CORE_COMMON_H_
#define HL_NAVIGATION_CORE_COMMON_H_
...
struct Twist2 {
  ...
  Twist2 rotate(Radians angle) const {
    return {::hl_navigation::core::rotate(velocity, angle), angular_speed};
  }
...
struct Pose2 {
  ...
  Pose2 rotate(Radians angle) const {
    return {::hl_navigation::core::rotate(position, angle), orientation + angle};
  }
  ...
  Pose2 integrate(const Twist2& twist, float dt) {
    return {position +
                dt * (twist.frame == Frame::relative
                          ? ::hl_navigation::core::rotate(twist.velocity, orientation)
                          : twist.velocity),
...
inline std::ostream& operator<<(std::ostream& os,
                                const hl_navigation::core::Frame& frame) {
  os << "Frame::" << (frame == hl_navigation::core::Frame::relative ? "relative" : "absolute");
  return os;
}

inline std::ostream& operator<<(std::ostream& os,
                                const hl_navigation::core::Vector2& vector) {
  os << "Vector2(" << vector[0] << ", " << vector[1] << ")";
  return os;
}

inline std::ostream& operator<<(std::ostream& os,
                                const hl_navigation::core::Twist2& twist) {
...
inline std::ostream& operator<<(std::ostream& os,
                                const hl_navigation::core::Pose2& pose) {
  os << "Pose2(" << pose.position << ", " << pose.orientation << ")";
  return os;
}

#endif  // HL_NAVIGATION_CORE_COMMON_H_
