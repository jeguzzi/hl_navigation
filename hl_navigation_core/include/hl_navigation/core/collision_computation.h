...
#ifndef HL_NAVIGATION_CORE_COLLISION_COMPUTATION_H_
#define HL_NAVIGATION_CORE_COLLISION_COMPUTATION_H_
 ...
 * disc-cache margin.
 */
struct HL_NAVIGATION_CORE_EXPORT DiscCache {
  /**
 ...
 */
class HL_NAVIGATION_CORE_EXPORT CollisionComputation {
 public:
  /**
...
#endif  // HL_NAVIGATION_CORE_COLLISION_COMPUTATION_H_
