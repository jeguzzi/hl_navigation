#ifndef HL_NAVIGATION_CORE_KINEMATICS_H_
#define HL_NAVIGATION_CORE_KINEMATICS_H_
 ...
 */
class HL_NAVIGATION_CORE_EXPORT Kinematics : virtual public HasProperties,
 ...
 */
class HL_NAVIGATION_CORE_EXPORT OmnidirectionalKinematics : public Kinematics {
 public:
  /**
 ...
 * move (e.g., people)
 */
class HL_NAVIGATION_CORE_EXPORT AheadKinematics : public Kinematics {
 public:
  /**
   * @brief      Constructs a new instance.
   *
 ...
 */
class HL_NAVIGATION_CORE_EXPORT WheeledKinematics : public Kinematics {
 public:
 ...
 */
class HL_NAVIGATION_CORE_EXPORT TwoWheelsDifferentialDriveKinematics
 ...
 */
class HL_NAVIGATION_CORE_EXPORT FourWheelsOmniDriveKinematics
    : public WheeledKinematics {
 public:
  /**
   * @brief      Constructs a new instance.
