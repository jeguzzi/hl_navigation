#ifndef HL_NAVIGATION_CORE_YAML_REGISTER_H
#define HL_NAVIGATION_CORE_YAML_REGISTER_H

#include <memory>

#include "hl_navigation/core/register.h"
#include "hl_navigation/core/yaml/property.h"
...
#endif  // HL_NAVIGATION_CORE_YAML_REGISTER_H