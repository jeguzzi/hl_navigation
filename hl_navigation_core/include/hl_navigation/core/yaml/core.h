#ifndef HL_NAVIGATION_CORE_YAML_CORE_H
#define HL_NAVIGATION_CORE_YAML_CORE_H
...
#include "hl_navigation/core/yaml/register.h"
...
using hl_navigation::core::SocialMargin;
...
#endif  // HL_NAVIGATION_CORE_YAML_CORE_H
