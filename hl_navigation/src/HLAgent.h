...
typedef struct{
    ...
    public:
      ...
      virtual void addObstacleAtPoint(CVector2 point,Real radius,Real socialMargin);
      virtual void addObstacleAtPoint(CVector2 point,CVector2 velocity,Real radius,Real socialMargin);
    ...
    CVector2  previousDesiredVelocity;    
        ...
        AgentCache makeObstacleAtPoint(CVector2 p, CVector2 v, Real r,Real socialMargin);
