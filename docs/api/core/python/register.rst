...
For each C++ template class :cpp:class:`hl_navigation::core::HasRegister`, we expose a Python class
...
.. autodecorator:: hl_navigation.core.registered_property


.. autoclass:: hl_navigation.core._hl_navigation.BehaviorRegister
   :exclude-members: __new__, __init__

   This register holds any behavior registered in :cpp:class:`hl_navigation::core::HasRegister<Behavior>` as well
   as registered Python sub-classes of :py:class:`hl_navigation.Behavior`.
...
.. autoclass:: hl_navigation.core._hl_navigation.KinematicsRegister
   :exclude-members: __new__, __init__

   This register holds any kinematics registered in :cpp:class:`hl_navigation::core::HasRegister<Kinematics>` as well
   as registered Python sub-classes of :py:class:`hl_navigation.Kinematics`.
