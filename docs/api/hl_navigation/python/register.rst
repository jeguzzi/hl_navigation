...
For each C++ template class :cpp:class:`hl_navigation::HasRegister`, we expose a Python class
...
.. autodecorator:: hl_navigation.registered_property


.. autoclass:: hl_navigation._hl_navigation.BehaviorRegister
   :exclude-members: __new__, __init__

   This register holds any behavior registered in :cpp:class:`hl_navigation::HasRegister<Behavior>` as well
...
.. autoclass:: hl_navigation._hl_navigation.KinematicsRegister
   :exclude-members: __new__, __init__

   This register holds any kinematics registered in :cpp:class:`hl_navigation::HasRegister<Kinematics>` as well
