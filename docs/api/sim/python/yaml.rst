...
in addition to :py:class:`hl_navigation.sim.Agent`, :py:class:`hl_navigation.sim.World`, and :py:class:`hl_navigation.sim.Experiment`:
...
.. autofunction:: hl_navigation.sim.dump
